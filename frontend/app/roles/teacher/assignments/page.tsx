...
export default function TeacherAssignmentsPage() {
  ...
  return (
    <ProtectedRoute allowedRoles={['Teacher']}>
      <RoleDashboardShell title="Teacher Assignments" role="Teacher">
          ...
          <div className="section-row">
            <div>
              ...
              <p style={{ color: 'var(--muted)' }}>
                Publish assignments so students can submit their work on time.
              </p>
            </div>
          </div>
        ...
        <section className="card">
          <div className="section-row">
            <div>
              <h2>Assignments</h2>
              <p style={{ color: 'var(--muted)' }}>Manage assignments for your classes and review published content.</p>
            </div>
          </div>
